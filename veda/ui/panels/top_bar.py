...
class TopBar(ctk.CTkFrame):
    def __init__(self, master, theme: VedaTheme, state: VedaState):
        super().__init__(master, fg_color=theme.bg_topbar, height=theme.topbar_height, corner_radius=0)
        self.theme = theme
        self.state = state
        ...
        self.title_label = ctk.CTkLabel(
            self, text="VEDA CORE",
            font=("Orbitron", 14, "bold"), text_color=theme.idle
        )
