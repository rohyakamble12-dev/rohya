...
class VedaLLM:
    ...
    def extract_intent(self, user_input):
        ...
        intent_prompt = (
            ...
            "User: 'delete this old folder' -> {'intent': 'delete_item', 'params': {'path': 'old folder'}}\n"
            "User: 'convert photo.png to jpg' -> {'intent': 'convert_item', 'params': {'src': 'photo.png', 'target': 'jpg'}}\n"
            "User: 'zip up my project folder' -> {'intent': 'zip_item', 'params': {'path': 'project folder'}}\n"
            "User: 'unzip backup.zip' -> {'intent': 'unzip_item', 'params': {'path': 'backup.zip'}}\n"
            "User: 'find duplicates in documents' -> {'intent': 'find_duplicates', 'params': {'directory': 'documents'}}\n"
            "User: 'show me large files' -> {'intent': 'find_large_files', 'params': {}}\n"
            "User: 'encrypt secret.txt' -> {'intent': 'encrypt_item', 'params': {'path': 'secret.txt'}}\n"
            "User: 'organize my downloads' -> {'intent': 'organize_dir', 'params': {'directory': 'downloads'}}\n"
            "User: 'find files containing Stark' -> {'intent': 'search_content', 'params': {'query': 'Stark'}}\n"
            "User: 'rename all txt to old' -> {'intent': 'batch_rename', 'params': {'pattern': '.txt', 'replacement': '.old'}}\n"
            "User: 'start a new code project in my docs' -> {'intent': 'init_project', 'params': {'directory': 'my docs', 'type': 'code'}}\n"
            "User: 'analyze this folder' -> {'intent': 'folder_intel', 'params': {'directory': 'folder'}}\n"
            "User: 'backup my pictures' -> {'intent': 'backup_item', 'params': {'path': 'pictures'}}\n"
