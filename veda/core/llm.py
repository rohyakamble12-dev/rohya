...
class VedaLLM:
    def __init__(self, model="llama3.2:3b"):
        ...
        self.system_prompt = (
            ...
            "Your personality is a mix of JARVIS and FRIDAY—loyal, professional, and sharp. "
    ...
    def extract_intent(self, user_input):
        ...
        intent_prompt = (
            ...
            "screenshot, lock_pc, sleep, mute_toggle, morning_briefing, time, date, note, stock_price, "
            "crypto_price, remember_fact, vision_analyze, motivation, deep_research, read_doc, "
            "sys_health, net_info, storage_info, media_control, play_music, file_search, file_info, "
            "set_mode, translate, start_recording, stop_recording, play_macro, ingest_web, "
            "todo_add, todo_list, todo_complete, pomodoro, define_protocol, run_protocol, "
